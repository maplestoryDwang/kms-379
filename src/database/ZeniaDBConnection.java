...
public class ZeniaDBConnection {
   ...
   public static synchronized void init() {
      try {
         dataSource = setupDataSource("jdbc:mariadb://127.0.0.1:3309/odin_sea?characterEncoding=utf8&autoReconnect=true");
      } catch (Exception var1) {
         System.err.println("데이터베이스를 연결하는 과정에서 오류가 발생하였습니다.3\r\n" + var1.toString());
         System.exit(1);
      }

      System.out.println("강림 => 제니아 데이터베이스와 연결되었습니다.");
   }
